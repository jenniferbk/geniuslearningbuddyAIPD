// fix-chunks-now.js - Clear test chunks and create proper coverage
...
async function fixChunksNow() {
  ...
  try {
    // Step 1: Clear existing test chunks
    console.log('🗑️ Step 1: Clearing 5 test chunks...');
    ...
    // Step 2: Create proper chunks with full video coverage
    console.log('\n📊 Step 2: Creating 13 chunks with full coverage...');
    ...
    for (const chunk of properChunks) {
      stmt.run(
        ...
        0.88 // High confidence for realistic data
      );
    }
